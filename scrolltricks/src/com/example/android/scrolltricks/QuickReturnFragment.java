...
public class QuickReturnFragment extends Fragment implements ObservableScrollView.Callbacks {
        ...
        mObservableScrollView.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        Log.d("onGlobalLayout",mObservableScrollView.computeVerticalScrollRange() + " : " + mObservableScrollView.getHeight() + " : " + mQuickReturnView.getHeight());
    ...
    public void onScrollChanged(int scrollY) {
        ...
        Log.d("onScrollChanged",mMaxScrollY + " : " + scrollY + " : " + Math.min(mMaxScrollY, scrollY));
